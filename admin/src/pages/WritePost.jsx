import { Button, Select, TextInput, useMantineColorScheme } from "@mantine/core";
...
const WritePost = () => {
  ...
  <>
    <RichTextEditor editor={editor}>
      <div className="w-full flex flex-col md:flex-row felx-wrap gap-5 mb-8">
        <TextInput
          withAsterisk
          label='post title'
...
<RichTextEditor.Toolbar sticky stickyOffset={20}>
 <RichTextEditor.ColorPicker
    ...
    <div className="w-full flex items-end justify-end mt-6">
      <Button className={theme ? "bg-blue-600" : "bg-black"}
