...
import { useResend, useVerification } from "../hooks/auth-hooks";
...
const OTPVerification = () => {
  ...
  return (
    <div className={clsx("w-full h-screen flex flex-col items-center justify-center", 
    theme
    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-centermb-6">

            <p className={clsx("text-2xl font-semibold text-center",
            ...
            <span className={clsx("text-sm",
              ...
              >
                  Write OTP code sent to your Email.
        ...
        />
          <div className="pt-5 flex items-center justify-center gap-3 text-base">
            {seconds === 0 ? (
              <a className="text-base text-blue-600 underline cursor-pointer"
