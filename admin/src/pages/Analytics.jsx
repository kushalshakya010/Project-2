...
console.log(data)
  ...
  <div className="w-full">
    ...
    <div className="w-full py-8 ">
      <p className="py-5 tetx-base font-medium ">View Stats for last {numOfDays} days</p>

      <Graph dt={data?.viewStats}/>
    </div>

    <div className="w-full py-8 ">
      <p className="py-5 tetx-base font-medium ">Followers Stats for last {numOfDays} days</p>
