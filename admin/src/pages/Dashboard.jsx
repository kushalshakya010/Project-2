...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="w-full py-8 ">
      <p className="py-5 tetx-base font-medium ">View Stats for last 28 days</p>
    ...
    <div className="flex gap-6 flex-col md:flex-row py-6">
        ...
        <div className="w-full md:w-2/3 flex flex-col">
          <span className={clsx("py-5 text-base font-medium", theme ? "text-white" : "text-slate-600")}>Recent 5 Content</span>
