...
if (user.token) window.location.replace("/");
  ...
  return <div className="flex w-full h-[100vh]">
    ...
    <div className="flex w-full md:2/3 h-full bg-white dark:bg-gradient-to-b md:dark:bg-gradient-to-r from-black via-[#071b3e] to-black items-center px-10 md:px-20 lg:px-40 ">
      <div className="h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="">
              <h2 className="mt-6 text-center text-2xl md:text-3xl font-semibold text-grey-900 dark:text-white">Sign in to your account</h2>
          </div>
